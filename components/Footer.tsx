        ...
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-red-500 tracking-tight">Jeevadeepti</span>
            </div>
          ...
          <div className="w-full max-w-sm bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-5 text-center shadow-sm">
            ...
            <div className="flex justify-center gap-3">
              ...
              >
                <Phone className="h-4 w-4 text-red-400 group-hover:text-red-600" />
                <span>Call</span>
              </a>
          ...
          {/* 3. Links & Copyright Section */}
          <div className="text-center border-t border-gray-800 w-full pt-8">

            {/* --- NEW: Legal & Navigation Links --- */}
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-6 text-sm font-medium text-gray-400">
              <Link to="/search" className="hover:text-white hover:underline transition-colors">
                Find Donors
              </Link>
              <Link to="/awareness" className="hover:text-white hover:underline transition-colors">
                Awareness (അറിവ്)
              </Link>
